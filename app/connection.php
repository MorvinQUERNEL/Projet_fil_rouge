...
<head>
    ...
    <title>Click & Sport - Connexion</title>
    ...
    <main class="connexion-container">
        ...
        <form class="connexion-form">
            <div class="form-group">
                ...
                <input type="email" placeholder="exemple@click&sport.com">
            </div>
        ...
        <p class="create-account">
            Pas encore de compte? <a href="#">Créez-en un ici</a>
        </p>
    </main>
<footer>
    <h2>Suivez-nous</h2>
